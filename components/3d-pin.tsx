    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2  flex justify-start items-start  rounded-2xl  border transition duration-700 overflow-hidden"
        >
...
export const PinPerspective = ({
  ...
  return (
    <motion.div className="pointer-events-none  w-96 h-64 md:h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        ...
        <div className="absolute top-0 inset-x-0  flex justify-center">
          ...
          >
            ...
            <span className="absolute -bottom-0 left-[1.125rem] h-px w-[calc(100%-2.25rem)] transition-opacity duration-500 group-hover/btn:opacity-40"></span>
          </p>
        </div>}
        ...
        >
          <>
            <motion.div
              ...
              className="absolute left-1/2 top-1/2  h-[.25rem] w-[11.25rem] rounded-[50%] bg-sky-500/[0.08]"
            ></motion.div>
            <motion.div
              initial={{
                opacity: 0,

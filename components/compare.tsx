  ...
  return (
    ...
    >
      <AnimatePresence initial={false}>
        <motion.div
          className="h-full w-[3px] absolute top-0 m-auto z-30 bg-gradient-to-b from-transparent from-[5%] to-[95%] via-white to-transparent"
          style={{
            left: `${sliderXPercent}%`,
            top: "0",
            zIndex: 40,
          ...
          {firstImage ? (
            ...
            >
              <img
                ...
                src={firstImage}
                className={cn(
                  "absolute inset-0  z-20 r flex-shrink-0 w-full h-full select-none",
                  firstImageClassName
                )}
                draggable={false}
              />
